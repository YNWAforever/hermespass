...
import { Activity, CreditCard, FileCheck2, Fingerprint, type LucideIcon } from "lucide-react";
...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "HermesPass Product — Identity, Authority, Spend, Evidence",
    description:
          ...
          <div className="grid items-start gap-10 lg:grid-cols-2">
            ...
            <div className="panel p-5">
              ...
              <dl className="mt-4 divide-y divide-border">
                {f.visual.map(([k, v]) => (
                  <div key={k} className="flex flex-wrap items-baseline justify-between gap-2 py-3">
                    <dt className="font-mono text-[11px] text-cyan-accent">{k}</dt>
                    <dd className="font-mono text-xs break-all text-muted-foreground">{v}</dd>
                  </div>
                ))}
              </dl>
            </div>
