...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "HermesPass Use Cases — Governed AI Agent Workflows",
    description:
        ...
        <div className="grid gap-5 lg:grid-cols-2">
          {USE_CASES.map(({ icon: Icon, title, agent, before, flow }) => (
            <article key={title} className="panel flex flex-col p-6">
              ...
              <p className="mt-3 text-xs tracking-wide text-risk-high uppercase">Today</p>
              <p className="mt-1 text-sm leading-relaxed text-muted-foreground">{before}</p>
