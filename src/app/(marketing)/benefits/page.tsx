...
import { Blocks, Clock, Fingerprint, Gauge, ScrollText, ShieldCheck, Wallet } from "lucide-react";
...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Benefits of HermesPass — Know Your Agent Infrastructure",
    description:
      ...
      <Section>
        <div className="panel grid gap-6 p-8 sm:grid-cols-3">
          {[
            ...
            <div key={s.stat}>
              <p className="font-mono text-2xl font-semibold text-emerald-accent">{s.stat}</p>
