...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "HermesPass Pricing — Pilot, Growth, Enterprise",
    description:
      ...
      <Section>
        <div className="grid gap-5 lg:grid-cols-3">
          {TIERS.map((t) => (
            <div
              key={t.name}
              className={cn("panel flex flex-col p-6", t.highlight && "shadow-glow-emerald")}
            >
              {t.highlight ? (
              ...
              <p className="mt-5 font-mono text-xl font-semibold text-emerald-accent">{t.price}</p>
