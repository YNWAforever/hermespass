...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "HermesPass Compliance — Standards and Control Mapping",
    description:
...
const MAPPING: Array<[string, string, string]> = [
  ...
  ["Reporting", "CSV export and print-ready report over any period", "Compliance exporter"],
];
    ...
    <SiteShell>
      ...
      <Section>
        ...
        <p className="mt-6 max-w-3xl text-xs leading-relaxed text-muted-foreground">
          HermesPass supports your compliance work against these frameworks. Alignment is a shared
          responsibility with your own risk, legal and compliance functions — no framework certifies
            ...
            <tbody className="divide-y divide-border">
              {MAPPING.map(([expectation, how, control]) => (
                <tr key={expectation}>
                  ...
                  <td className="px-4 py-3 font-mono text-xs text-cyan-accent">{control}</td>
                </tr>
              ))}
            </tbody>
          </table>
