            ...
            <div className="panel sticky top-24">
              ...
              <div className="mt-6 rounded-md border border-border bg-surface p-4 text-sm text-muted-foreground">
                ...
                <ul className="mt-2 space-y-1.5 text-xs">
                  <li>
                    • {Math.round(LABOUR_TIME_REDUCTION * 100)}% reduction in manual review time
                    after KYA passporting
                  </li>
                  <li>
                    • {Math.round(SPEND_CAPTURE_RATE * 100)}% of unmanaged spend is prevented or
                    recovered through scoped controls
                  </li>
                  <li>
                    • Values are estimates; actual savings depend on policy maturity and agent
                    estate
                  </li>
                </ul>
              </div>
